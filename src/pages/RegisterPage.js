            ...
            <div className="card border-0 shadow-sm p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input type="tel" name="phone" className="form-control" placeholder="+1 234 567 8900" value={form.phone} onChange={handleChange} />
                </div>
                <div className="mb-4">
              ...
              <p className="text-center mt-3 mb-0 text-muted small">
                Already have an account? <Link to="/login" className="text-decoration-none fw-semibold" style={{ color: 'var(--primary)' }}>Sign in</Link>
              </p>
            </div>
